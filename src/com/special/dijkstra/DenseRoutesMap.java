...
public class DenseRoutesMap
	...
	public final double[][] distances;//TODO set private after tests
	 ...
	 */
	public void addDirectRoute(City city1, City city2, double distance)
	{
		distances[city1.getIndex()][city2.getIndex()] = distance;
	}
